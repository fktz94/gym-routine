...
1. Add a _'c/l'_ button to dynamically add it if necesarry instead of customizing the value. --> **In progress**
2. BUG - After the routine screen is loaded or reloaded, first try to edit weight (no matter which exercise) opens and close instantanely. After that, it works fine.
